    ...
    <div className='grid grid-cols-4 gap-4 px-10 py-4 w-[100%]'>
    {
        menus.map((menu) => {
            return (
                ...
                justify-between p-4 rounded-lg h-[100px] cursor-pointer'
                style={{backgroundColor: getRandomBG(menu.id)}}
                  onClick={() => {
                setSelected(menu);
                setItemId(0);
                setItemCount(0);
    ...
    <div className='grid grid-cols-4 gap-4 px-10 py-4 w-[100%]'>
    {
        selected?.items.map((item) => {
            return (
                ...
                justify-between p-4 rounded-lg  h-[150px] cursor-pointer hover:bg-[#2a2a2a]
                bg-[#1a1a1a]'
               > 
