...
const BottomNav = () => {
  ...
  return (
    <div className='fixed bottom-0 left-0 right-0 bg-[#262626] p-2 h-16 flex justify-around'>
          <button onClick={() => navigate("/home")} className={`flex items-center justify-center font-bold ${isActive("/home") ? 'text-[#f5f5f5] bg-[#343434]' 
          ...
          ${isActive("/orders") ? 'text-[#f5f5f5] bg-[#343434]' 
            : 'text-[#ababab]'}  w-[300px] rounded-[20px]`}> 
            <MdOutlineReorder className='inline mr-2' size={20} /> <p> Orders </p> </button>
          ...
          onClick={openModal} 
          className='absolute bottom-6 items-center p-3 rounded-full bg-[#f6b100] text-[#f5f5f5]'>
            < BiSolidDish size={40}/>
             </button>     
              ...
              <div>
                <label className='block text-[#ababab] mb-2 text-sm font-medium'>
                   ...
                   <div className='flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]'>
                    ...
                    type="text" name='' placeholder='Enter customer name' id=''
              ...
              <div>
                <label className='block text-[#ababab] mb-2 text-sm font-medium'>
                   ...
                   <div className='flex items-center rounded-lg p-3 px-4 bg-[#1f1f1f]'>
                    ...
                    type="number" name='' placeholder='+977-99999999' id=''
                    className='bg-transparent flex-1 text-white focus:outline-none' />
